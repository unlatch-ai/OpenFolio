...
## App Still Shows Login/Signup in Self-Hosted Mode

Verify mode variables in your `.env`:
...
Then rebuild/restart the app container so client build-time envs are refreshed:
