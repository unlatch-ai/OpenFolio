  ...
  return (
    <div className="page-shell">
      <div className="page-frame">
        ...
        <section className="hero">
          <p className="eyebrow">Hosted account</p>
          <h1>Manage the account your Mac app uses.</h1>
          <p>
            The local graph stays on your Mac. This hosted account only handles identity, billing,
            managed connectors, and future sync.
          </p>
