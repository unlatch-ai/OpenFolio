    ...
    <div className="page-shell">
      <div className="page-frame">
        ...
        <section className="hero">
          <p className="eyebrow">macOS app + hosted services</p>
          ...
          <p>
            ...
            graph local, while hosted services handle account creation, billing, managed AI, and future connectors.
          </p>
        ...
        <section className="section">
          ...
          <div className="docs-grid">
            <Link className="doc-card" href="/docs/getting-started">
              ...
              <p>Install the Mac app, create your account, grant Full Disk Access, and import Messages.</p>
            </Link>
