...
public final class PermissionCenter {
    ...
    public convenience init(appName: String? = nil) throws {
        try self.init(appName: appName, bundleURL: nil)
    }

    public init(appName: String? = nil, bundleURL: URL?) throws {
        let resolvedBundleURL = try bundleURL ?? Self.resolveHostApplicationBundle()
